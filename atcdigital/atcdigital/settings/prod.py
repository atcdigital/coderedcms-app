...
SECRET_KEY = '(#*%q%t*6wc8huag2^5nh-9temg8bkg1_zuauw3s-eop@v8_p3'

# Add your site's domain name(s) here.
ALLOWED_HOSTS = ['atc.digital']
...
DEFAULT_FROM_EMAIL = 'ATC.Digital <info@atc.digital>'

# A list of people who get error notifications.
ADMINS = [
    ('Administrator', 'admin@atc.digital'),
]
